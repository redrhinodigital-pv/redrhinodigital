      ...
      <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <motion.h1
            ...
            className="text-5xl sm:text-6xl md:text-7xl font-display font-extrabold text-foreground tracking-tight mb-8"
          >
          ...
          >
            Chennai-based digital agency delivering digital marketing, IT solutions, and AI-powered growth systems.
          </motion.p>
          ...
          <motion.p
            ...
            className="text-lg md:text-xl text-foreground font-medium mb-12 max-w-2xl mx-auto leading-relaxed"
          >
            We don’t just market your brand — we build systems that grow your business.
          </motion.p>
